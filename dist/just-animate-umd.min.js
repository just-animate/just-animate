...
function n(t){-1===f.indexOf(t)&&f.push(t),u||(u=requestAnimationFrame(p))}function p(){for(var t=performance.now(),e=0;e<f.length;e++){f[e](t)||(f.splice(e,1),e--)}if(u=f.length?requestAnimationFrame(p):0,a){var n=a
...
return n&&(t.match=n[0],t.last=t.pos,t.pos+=t.match.length),null!=n}function T(t){if(b(t,h))return m
...
P(L,t)
var r=0,i=""
for(;1&&(e=b(a=L,h)?m:b(a,v)?x:b(a,g)?_:b(a,c)?S:void 0);)e===S&&(n=L.match.toLowerCase(),r=0),e===_||e===x?("matrix"===n?i+=r%3?"0":"1":"matrix3d"===n?i+=r%5?"0":"1":/scale([xyz]|3d)?/i.test(n)?i+="1":i+="0",r++):i+=L.match
var a
...
s?(d=+o,m=+u,b=n,f=Math.round(Math.sqrt(Math.min(Math.max(0,(d*d+m*m)*b),255*255))),s--):f=N(+o,+u,n),a+=f}else if(r===_||i===_){var p=O.exec(r===_?o:u),h=p[1],l="px"===h,c=parseFloat(o),v=parseFloat(u),f=N(c,v,n,l)
...
function $(t){var e=k(t-X,0,2*Y)
X=t
for(var n=Z.slice(),r=0,i=n;r<i.length;r++){rt(e,d=i[r])}for(var a=0,s=n;a<s.length;a++){nt(d=s[a])}for(var o=[],u=0,f=n;u<f.length;u++){for(var p=0,h=(d=f[u]).events;p<h.length;p++){var l=h[p]
...
tt(d=y[g],v)}for(var m=Z.length-1;-1<m;m--)"running"!==n[m].playState&&Z.splice(m,1)
for(var b=0,x=v;b<x.length;b++){(0,x[b])()}for(var _=0,S=o;_<S.length;_++){(0,S[_])(t)}return!!Z.length}function tt(t,T){var O=t.currentTime
for(var e in t.keyframes){var i=t.keyframes[e],a=et(t,e),n=function(S){for(var t,k=i[S],P=(t=k,Object.keys(t).map(o).sort(s)),e=function(t){var e,n,r,i,a,s,o,u=(n=S,"string"==typeof(e=t).tagName&&e.style?0===n.indexOf("--")?D:-1!==Q.indexOf(n)?J:-1!==U.indexOf(n)?V:K:V),f=(r=u)===J?j:r===D?A:r===K?q:C,p=(i=u)===J?w:i===D?F:i===K?z:R,h=I,l=f(t,S),c=M(P,O),v=-1===c?0:P[c],g=k[P[c]],y=Math.min(c+1,P.length-1),d=P[y],m=k[d].value,b=void 0
if(g)b=g.value
else{var x=W(t,S)
null==x&&(s=S,o=x=l,(a=t)["__ja"]||(a["__ja"]={}),a["__ja"][s]=o),b=x}var _=h(b,m,(v-O)/(v-d))
...
"cancel"===e.playState?(e.currentTime=0,e.playbackRate=1):"finish"===e.playState?e.currentTime=e.playbackRate<0?0:n:"running"===e.playState&&(e.currentTime+=t*e.playbackRate),e.currentTime=k(e.currentTime,0,n)}var it=function(){function e(t){if(!(this instanceof e))return new e(t)
this.alternate=!1,this.currentTime=0,this.events=[],this.iterations=1,this.keyframes={},this.labels={},this.listeners={},this.playState="running",this.playbackRate=1,this.targetIds_=0,this.targets={},this.timelines_=[],t&&this.configure(t)}return Object.defineProperty(e.prototype,"duration",{get:function(){for(var t=0,e=0,n=this.timelines_;e<n.length;e++){var r=n[e],i=r.animation.duration+r.pos
...
return t=this,Z.length||(X=performance.now(),n($)),-1===Z.indexOf(t)&&Z.push(t),this},e}()
t.animate=function(t,e,n){return(new it).animate(t,e,n)},t.nextAnimationFrame=function(){return i||(i=new Promise(function(t){a=t})),u||(u=requestAnimationFrame(p)),i},t.tick=n,t.Timeline=it,Object.defineProperty(t,"__esModule",{value:!0})})
