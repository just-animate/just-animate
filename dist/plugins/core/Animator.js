...
var keyframes_1 = require('../../common/keyframes');
...
function Animator(resolver, timeloop) {
    ...
    self._iterations = 1;
    self._lastTick = resources_1.nil;
