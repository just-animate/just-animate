...
n.nextValues={},n.import(t)}),n.values={},n.nextValues=t||{},n.onPropertyUpdated()}return t.prototype.keys=function(){return Object.keys(this.values)},t.prototype.set=function(t,e){u(t)&&(this.nextValues[t]=e,this.onPropertyUpdated())},t.prototype.get=function(t){return this.values[t]},t.prototype.export=function(){return JSON.parse(JSON.stringify(this.values))},t.prototype.import=function(t){for(var e in this.change.next(t),t)this.values[e]=t[e]},t}(),m=function(t){function e(){var e=null!==t&&t.apply(this,arguments)||this
...
if((f=e[u])!==n){var h=t.targets[u],l=j(t,u,f===r||f===i?h:c(h,v(e).filter(function(t){return e[t]===r||e[t]===i})))
...
function j(t,e,n){for(var r=t.duration,i=function(t,n){return e.split(",").map(function(e){return f(e)&&"@"===e[0]?function(t,n){var r=e.substring(1)
...
y&&y.length&&(p(s,y),l=h(l,c=y.map(A).reduce(p,c)))}return s}function A(t){return t.props}var _="running",N=17
...
l.push(((f={offset:m,easing:T})[r]=b.value,f))}return i||((a=h(l[0])).offset=0,l.push(a)),s||((a=h(l[l.length-1])).offset=1,l.push(a)),{props:[r],created:function(){(o=e.animate(l,{duration:t.duration,fill:"both"})).pause()},updated:function(e){var n=e.time,r=e.rate,i=e.state===_
if(Math.abs(o.currentTime-n)>1&&(o.currentTime=n),i&&o.playbackRate!==r){var s=o.currentTime
1>s?o.currentTime=1:s<t.duration-1||(o.currentTime=t.duration-1),o.playbackRate=r}i&&!(o.playState===_||"finished"===o.playState)&&!(0>r&&N>n)&&!(r>=0&&n>t.duration-N)&&o.play(),!i&&(o.playState===_||"pending"===o.playState)&&o.pause()},destroyed:function(){o.cancel()}}})}}),t.Observable=e,t.Dictionary=b,t.nextTick=y,t.scheduler=d,t.timer=x,t.Timer=m,t.refs=k,t.use=S,t.Timeline=w,t.timelines=T,t}({})
