...
KeyframeAnimation.prototype = {
    _dispatcher: nil as IDispatcher,
    _duration: nil as number,
    _endTime: nil as number,
    _iterationStart: nil as number,
    _iterations: nil as number,
    _startTime: nil as number,
    _totalDuration: nil as number,
